...
with filter_tab:
    ...
    if geo_input_filters == 'League':
        with st.form('Time Frame Filters, League'):
            ...
            time_frame_filters = st.multiselect('League-Seasons', (similar_player_lg_lookup_filters[similar_player_lg_lookup_filters.League.isin(region_filters)].sort_values(by=['Country','Season'],ascending=[True,False])['League-Season'].tolist()), default='Danish 1. Division 24-25')
