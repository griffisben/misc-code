...
rank_list = make_rankings(formation, mins, clean_df, role_position_df, [lg], exp_contracts, expiration_date,
                          min_age=ages[0], max_age=ages[1], num=number_of_players, normalize_to_100=normalize_to_100, chosen_team=chosen_team, nationality_chosen=nationality_chosen)
