...
def similar_players_search(df, ws_id, pos, pca_transform, compare_metrics, mins, age_band):
    ...
    return similar_players[['Rank','Similarity %','Player','Age','Passport country','Team','Minutes played','Position','League','On loan','Market value']], focal_player['Player'].iloc[0], focal_player['Age'].iloc[0], focal_player['Position'].iloc[0], focal_player['Team within selected timeframe'].iloc[0]
