...
rank_11_base = read_csv('https://raw.githubusercontent.com/griffisben/misc-code/main/files/Ranking_XI.csv')
role_position_lookup = read_csv('https://raw.githubusercontent.com/griffisben/misc-code/main/files/Role_Positions_Lookup.csv')
