...
try:
    ...
    region_colors = {region: color for region, color in zip(path_league_info['Region'].unique(), alt.Scale(domain=path_league_info['Region'].unique(), range=alt.themes.default['category10']))}
